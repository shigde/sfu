...
type LiveStream struct {
	...
	Account   *account.Account   `json:"-" gorm:"foreignKey:AccountId;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;"`
...
func NewLiveStream(account *account.Account, lobbyEntity *lobby.LobbyEntity, space *Space, video *models.Video) *LiveStream {
